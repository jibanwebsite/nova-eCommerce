  ...
  return (
    <div className="w-full bg-[#f4f6f8]">
       <div 
        ...
        >
          <div className="relative w-full bg-white h-[400px] md:h-[550px] flex flex-col md:flex-row overflow-hidden shadow-sm">
              ...
              {slides.map((slide, index) => (
                ...
                >
                  ...
                  <div className="w-full h-[60%] md:w-[70%] md:h-full relative bg-gray-50">
                      {slide.brandBadge && (
                       <div className="absolute top-8 left-8 bg-greeny px-4 py-2 shadow-sm z-10">
                          <span className="text-white font-bold text-lg tracking-widest uppercase flex items-center gap-1">
                            <span className="text-2xl leading-none">{slide.brandBadge.charAt(0)}</span>{slide.brandBadge.slice(1)}
                          </span>
                       </div>
                      )}
                  ...
                  <div className="w-full h-[40%] md:w-[30%] md:h-full flex flex-col justify-center px-6 md:px-16 bg-white relative py-4 md:py-0">
                      ...
                      {slide.logos && (
                        <div className="flex items-center gap-4 mb-6">
                            <div className="border border-gray-200 p-1 w-16 h-10 flex items-center justify-center">
                              <span className="font-extrabold text-black italic tracking-tighter text-lg">HRX</span>
                            </div>
                            <div className="border border-gray-200 p-1 w-16 h-10 flex items-center justify-center">
                              <svg viewBox="0 0 24 24" className="w-10 h-6 fill-current text-black">
                                  <path d="M21.25 4.5l-13.5 12.5-5.5-5.5" fill="none" stroke="currentColor" strokeWidth="4" />
                                  <path d="M2 12c0 0 5 4 9 4s11-10 11-10" fill="none" stroke="currentColor" strokeWidth="3" style={{strokeLinecap: "round"}} />
                              </svg>
                            </div>
                            <span className="text-gray-500 font-serif text-lg italic">& More</span>
                        </div>
                      )}
                      ...
                      <div className="flex">
                        <Button variant="link" className="text-sm md:text-base font-semibold text-gray-500 border-b border-gray-300 pb-1 hover:text-black hover:border-black transition-colors uppercase tracking-wide p-0 h-auto rounded-none hover:no-underline">
                          + Explore
                        </Button>
                      </div>
                  </div>
          ...
          <div className="absolute bottom-10 md:-bottom-8 left-1/2 transform -translate-x-1/2 flex gap-2 z-30">
             {slides.map((_, index) => (
               <Button 
                 key={index}
                 variant="ghost"
