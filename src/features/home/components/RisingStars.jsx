...
const risingStarsData = [
  {
    ...
    image: "/src/assets/images/slider/risingstar/comfort.jpg", // Fashion model
    brand1: "SNITCH",
    brand2: "Bewakoof",
  ...
  },
  {
    ...
    image: "/src/assets/images/slider/risingstar/tokyowears.jpg", // Fashion model
  ...
  },
  {
    ...
    image: "/src/assets/images/slider/risingstar/berrylush.jpg", // Fashion model with sunglasses
    brand1: "Berrylush",
    brand2: "STREET9",
  ...
  {
    id: 'dennison&faber',
    image: "/src/assets/images/slider/risingstar/dennison.jpg", // Men's fashion
    brand1: "DENNISON",
  ...
  {
      id: 'bhama&shae',
      image: "/src/assets/images/slider/risingstar/bhama.jpg", // Ethnic wear
      brand1: "Bhama",
      brand2: "Shae",
    ...
    {
      id: 'roadster&life',
      image: "/src/assets/images/slider/risingstar/roadster.jpg", // Men's casual
      brand1: "Roadster",
      brand2: "Life",
    ...
    {
      id: 'mast&harbour',
      image: "/src/assets/images/slider/risingstar/maH.jpg", // Women's accessories
      brand1: "Mast & Harbour",
      brand2: "",
    ...
    {
      id: 'louis&vanheusen',
      image: "/src/assets/images/slider/risingstar/louis.jpg", // Men's formal
    ...
    {
       id: 'levis&pepe',
       image: "/src/assets/images/slider/risingstar/levis.jpg", // Women's denim
       brand1: "Levis",
       brand2: "Pepe",
    ...
    {
       id: 'puma&adidas',
       image: "/src/assets/images/slider/risingstar/puma.jpg", // Sportswear
       brand1: "Puma",
       brand2: "Adidas",
       tagline: "Game On",
       discount: "Min. 30% Off",
      ...
      > 
            ...
            >
                {Array.from({ length: totalPages }).map((_, pageIndex) => (
                    <div key={pageIndex} className="w-full flex-shrink-0 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 bg-white border-b border-gray-200">
                        {risingStarsData.slice(pageIndex * itemsPerPage, (pageIndex + 1) * itemsPerPage).map((item) => (
                            <div key={item.id} className="relative group/card cursor-pointer hover:shadow-xl transition-shadow duration-300 border-r border-[#eaeaec] last:border-r-0 z-0 hover:z-10 bg-white">
                                {/* Image Container */}
                                        ...
                                        <div className="flex justify-between items-center mb-2 pb-2 border-b border-gray-200">
                                            ...
                                            <div className="flex-1 px-1 border-r border-gray-200 flex justify-center items-center h-8">
                                                {item.brand1 === 'SNITCH' ? (
                                                    <div className="flex items-center gap-1">
                                                        <span className="text-xl font-light text-gray-900 leading-none">#</span>
                                            ...
                                            {item.brand2 && (
                                                <div className="flex-1 px-1 flex justify-center items-center h-8">
                                                    <div className={`relative ${item.brand2 === 'Bewakoof' ? 'bg-[#FFD200] px-2 py-0.5' : ''}`}>
                                                        <span className={`text-[13px] font-bold font-sans tracking-wide ${item.brand2 === 'Bewakoof' ? 'text-black lowercase' : 'text-gray-900'}`}>
                                                            {item.brand2}
                                                        </span>
                                                        {item.brand2 === 'Bewakoof' && (
                                                            <span className="absolute -top-1 -right-2 text-[8px] font-bold text-black">®</span>
                                                        )}
                                                    </div>
                                                </div>
                                            )}
