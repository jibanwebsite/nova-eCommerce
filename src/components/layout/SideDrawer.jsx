  ...
  return (
    ...
    >
        ...
        <div 
          ...
          className="bg-[#535766] text-white flex flex-col items-center pt-4 cursor-pointer gap-5 hover:bg-gray-700 w-[40px] md:w-[45px] h-full shadow-[-4px_0_15px_rgba(0,0,0,0.15)] relative z-20"
        >
        ...
        {/* Drawer Content */}
        <div className="w-[280px] max-w-[80vw] md:w-[520px] md:max-w-none bg-[#fff5f5] h-full flex flex-col relative overflow-hidden font-sans border-l border-white/50">
             {/* Main Content */}
             <div className="flex-1 px-6 py-6 relative z-10 w-full flex flex-col justify-between">
                 ...
                 <div className="flex w-full relative">
                     ...
                     <div className="flex flex-col items-start pt-2 z-10 mt-4 md:mt-0">
                        ...
                        <h2 className="text-[36px] md:text-[52px] leading-none font-bold text-[#3e4152] tracking-tighter">300 OFF</h2>
                     </div>
                 ...
                 <div className="flex flex-col md:flex-row justify-between items-start md:items-end w-full pr-1 mt-auto gap-4 md:gap-0">
                     <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-1.5">
                            <span className="text-[#3e4152] text-[12px] md:text-[13px] font-bold">Coupon Code:</span>
                            <span className="text-[#3e4152] font-bold text-[13px] md:text-[15px]">MYNTRA300</span>
                        </div>
             ...
             {/* Footer Bar */}
             <div className="bg-[#fcfcfc] py-2 px-6 flex justify-between border-t border-gray-100 shadow-[0_-4px_12px_rgba(0,0,0,0.03)] z-30 relative items-center">
                <div className="flex flex-col items-center gap-1 group cursor-default">
                  <BadgeCheck className="w-4 h-4 text-emerald-500 group-hover:scale-110 transition-transform" />
                  <span className="text-[8px] text-[#535766] font-bold text-center leading-tight tracking-tight">Genuine<br/>Products</span>
                </div>
                <div className="flex flex-col items-center gap-1 group cursor-default">
                  <Truck className="w-4 h-4 text-emerald-500 group-hover:scale-110 transition-transform" />
                  <span className="text-[8px] text-[#535766] font-bold text-center leading-tight tracking-tight">Try &<br/>Buy</span>
                </div>
                 <div className="flex flex-col items-center gap-1 group cursor-default">
                  <RefreshCcw className="w-4 h-4 text-emerald-500 group-hover:scale-110 transition-transform" />
                  <span className="text-[8px] text-[#535766] font-bold text-center leading-tight tracking-tight">Easy<br/>Exchanges & Returns</span>
                </div>
             </div>
        </div>
    </div>
